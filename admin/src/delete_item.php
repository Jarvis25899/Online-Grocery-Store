      ...
      <main class="main">
        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
            ...
            <div class="card">
            <div class="col-md-14" id="delete_msg3">
            </div>
              <div class="card-header">
                <i class="icon-drop"></i> Delete Brand</div>
              <div class="card-body">
              <form method="post">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input style="float:right;" value="Delete" type="button" id="delete_brand" name="delete_brand" class="btn btn-success btn-lg">
                            </div>
                        </div>
