      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="update_items.php">Update</a>
            </li>
          </ul>
        </nav>
      ...
      <main class="main">
        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
            <div class="card">
            <div class="col-md-14" id="update_msg">
            </div>
              <div class="card-header">
                <i class="icon-drop"></i> Update Item</div>
              <div class="card-body">
              <form method="post">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input style="float:right;" value="Update" type="button" id="update_button" name="update_button" class="btn btn-success btn-lg">
                            </div>
                        </div>
