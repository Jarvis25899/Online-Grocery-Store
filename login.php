...
<!-- header -->
	<div class="agileits_header">
		...
		<div class="w3l_header_right1">
			<h2 id='user_id'><a href="mail.php">Contact Us</a></h2>
		</div>
				...
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="#" method="post">
					  ...
					  <input type="submit" value="Login" id='login_id'>
					</form>
				  </div>
				  <div class="form">
					...
					<form action="#" method="post">
					  ...
					  <input type="email" id='email_reg' name="Email" placeholder="Email Address" required=" ">
